//https://teachablemachine.withgoogle.com/models/oPGGGrc9/
//https://teachablemachine.withgoogle.com/models/MO-UTY2Y/
//https://teachablemachine.withgoogle.com/models/aqBD4C43/
...
class ClassificationBar {
  ...
  updateClassification(results) {
    ...
    } else if (class2[0].confidence >= 0.95) {
      view[0] = 2;
      try {
        //port.send(view);
...
function gotList(thelist) {
  ...
  for (let i = 0; i < thelist.length; i++) {
    ...
    if(thelist[i] != portName){
      console.log(portName + " doesn't match:" + thelist[i]);
    }
